const STORE = {
 questions: {
  accessibility: [
   {
    question: "Which package contains the 'ifconfig' command ?",
    code: ``, 
    answers: [
     "net-tools",
     "apt-get",
    ...
    correctAnswer: "net-tools"
   },{
    question: "Which following command can list out all the current active logins ?",
    code: ``, 
    answers: [
     "whoami",
     "who",
